      ...
      regionOption: {
        ...
        column: [
          ...
          },
          {
            ...
            prop: 'regionLevel',
            type: 'radio',
            dicUrl: '/tw-recruit-api/blade-system/dict/dictionary?code=region',
            props: {
              label: 'dictValue',
              value: 'dictKey'
            },
        ...
        column: [
          {
            ...
            action: '/tw-recruit-api/blade-system/region/import-region'
          },
          {
            label: '数据覆盖',
            prop: 'isCovered',
        ...
        column: [
          {
            ...
            dicUrl: '/tw-recruit-api/blade-system/region/select',
            span: 24
          },
          {
            label: '地市',
            ...
            dicFlag: false,
            dicUrl: '/tw-recruit-api/blade-system/region/select?code={{key}}',
            span: 24
          },
          {
            label: '区县',
  ...
  watch: {
    ...
    'excelForm.isCovered'() {
      if (this.excelForm.isCovered !== '') {
        ...
        column.action = `/tw-recruit-api/blade-system/region/import-region?isCovered=${this.excelForm.isCovered}`
      }
    }
  },
  computed: {
  ...
  methods: {
    ...
    handleExport() {
      this.$confirm('是否导出行政区划数据?', '提示', {
        ...
        window.open(`/tw-recruit-api/blade-system/region/export-region?${this.website.tokenHeader}=${getToken()}`)
      })
    },
    handleTemplate() {
      window.open(`/tw-recruit-api/blade-system/region/export-template?${this.website.tokenHeader}=${getToken()}`)
    }
  }
}
</script>
