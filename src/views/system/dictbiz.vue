  ...
  <basic-container>
    ...
    >
      <template slot="menuLeft">
        <el-button type="danger" size="small" icon="el-icon-delete" v-if="permission.dictbiz_delete" plain @click="handleDelete">删 除</el-button>
      </template>
    ...
    <el-dialog :title="`[${dictValue}]字典配置`" append-to-body :visible.sync="box" width="1000px">
      ...
      >
        <template slot="menuLeft">
          <el-button type="danger" size="small" icon="el-icon-delete" v-if="permission.dict_delete" plain @click="handleDelete">删 除</el-button>
        </template>
        <template slot-scope="scope" slot="menu">
          <el-button
            type="text"
