  ...
  <basic-container>
    ...
    >
      <template slot="menuLeft">
        <el-button type="danger" size="small" icon="el-icon-delete" v-if="permission.tenant_delete" plain @click="handleDelete">删 除</el-button>
        ...
        column: [
          {
            ...
            span: 24,
            type: 'select',
            dicUrl: '/tw-recruit-api/blade-develop/datasource/select',
            props: {
              label: 'name',
              value: 'id'
            },
        ...
        column: [
          {
            ...
            span: 24,
            type: 'select',
            dicUrl: '/tw-recruit-api/blade-system/tenant-package/select',
            props: {
              label: 'packageName',
              value: 'id'
            },
