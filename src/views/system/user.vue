      ...
      option: {
        ...
        column: [
          ...
          },
          {
            label: '用户平台',
            type: 'select',
            dicUrl: '/tw-recruit-api/blade-system/dict/dictionary?code=user_type',
            props: {
              label: 'dictValue',
              value: 'dictKey'
            },
            ...
            column: [
              {
                ...
                prop: 'tenantId',
                type: 'tree',
                dicUrl: '/tw-recruit-api/blade-system/tenant/select',
                props: {
                  label: 'tenantName',
                  value: 'tenantId'
                },
        ...
        column: [
          {
            ...
            action: '/tw-recruit-api/blade-user/import-user'
          },
          {
            label: '数据覆盖',
            prop: 'isCovered',
  ...
  watch: {
    ...
    'excelForm.isCovered'() {
      if (this.excelForm.isCovered !== '') {
        ...
        column.action = `/tw-recruit-api/blade-user/import-user?isCovered=${this.excelForm.isCovered}`
      }
    }
  },
  computed: {
  ...
  methods: {
    ...
    handleExport() {
      this.$confirm('是否导出用户数据?', '提示', {
        ...
        window.open(
          `/tw-recruit-api/blade-user/export-user?${this.website.tokenHeader}=${getToken()}&account=${this.search.account}&realName=${
    ...
    handleTemplate() {
      window.open(`/tw-recruit-api/blade-user/export-template?${this.website.tokenHeader}=${getToken()}`)
    },
