...
export default {
      ...
      option: {
        ...
        column: [
          ...
          },
          {
            ...
            action: '/tw-recruit-api/blade-flow/manager/check-upload'
          }
        ]
      }
    }
  ...
  methods: {
    ...
    uploadAfter(res, done, loading) {
      ...
      if (res.success) {
        deployUpload(flowCategory(this.form.flowCategory), this.form.tenantId ? this.form.tenantId.join(',') : '', [this.file]).then(
          res => {
            const data = res.data
            if (data.success) {
              done()
