<template>
  <basic-container>
    ...
    >
      <template slot="menuLeft">
        <el-button
          ...
          @click="handleCreate"
        >创 建</el-button>
        <el-button type="danger" size="small" icon="el-icon-delete" v-if="permission.flow_model_delete" plain @click="handleDelete">删 除</el-button>
      </template>
    ...
    <el-dialog title="流程配置" append-to-body :visible.sync="flowBox" :fullscreen="true">
      <iframe
        :src="flowUrl"
        width="100%"
        height="700"
        ...
        column: [
          {
            label: '流程类型',
            type: 'select',
            dicUrl: '/tw-recruit-api/blade-system/dict/dictionary?code=flow',
            props: {
              label: 'dictValue',
              value: 'dictKey'
            },
