  ...
  <basic-container>
    ...
    >
      <template slot="menuLeft">
        <el-button type="danger" size="small" icon="el-icon-delete" plain v-if="permission.oss_delete" @click="handleDelete">删 除</el-button>
      </template>
...
export default {
        ...
        column: [
          {
            ...
            searchLabelWidth: 50,
            row: true,
            dicUrl: '/tw-recruit-api/blade-system/dict/dictionary?code=oss',
            props: {
              label: 'dictValue',
              value: 'dictKey'
            },
      ...
      debugOption: {
        ...
        column: [
          ...
          },
          {
            ...
            dataType: 'string',
            action: '/tw-recruit-api/blade-resource/oss/endpoint/put-file',
            propsHttp: {
              res: 'data',
              url: 'link'
            },
  ...
  watch: {
    ...
    'debugForm.code'() {
      ...
      column.action = `/tw-recruit-api/blade-resource/oss/endpoint/put-file?code=${this.debugForm.code}`
    }
  },
  computed: {
