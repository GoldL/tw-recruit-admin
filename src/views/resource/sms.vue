  ...
  <basic-container>
    ...
    >
      <template slot="menuLeft">
        <el-button type="danger" size="small" icon="el-icon-delete" plain v-if="permission.sms_delete" @click="handleDelete">删 除</el-button>
      </template>
        ...
        column: [
          {
            ...
            searchLabelWidth: 50,
            row: true,
            dicUrl: '/tw-recruit-api/blade-system/dict/dictionary?code=sms',
            props: {
              label: 'dictValue',
              value: 'dictKey'
            },
