  ...
  <basic-container>
    ...
    >
      <template slot="menuLeft">
        <el-button type="danger" size="small" icon="el-icon-delete" v-if="permission.code_delete" plain @click="handleDelete">删 除</el-button>
      ...
      option: {
        ...
        column: [
          ...
          },
          {
            ...
            prop: 'baseMode',
            type: 'radio',
            dicUrl: '/tw-recruit-api/blade-system/dict/dictionary?code=yes_no',
            props: {
              label: 'dictValue',
              value: 'dictKey'
            },
