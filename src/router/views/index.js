    ...
    children: [
      {
        ...
        name: '创建招聘会',
        meta: { i18n: 'work' },
        component: () => import(/* webpackChunkName: "views" */ '@/views/job/edit')
      },
      {
        path: 'fair/detail/:id',
        name: '招聘会详情',
        meta: { i18n: 'work' },
        component: () => import(/* webpackChunkName: "views" */ '@/views/job/detail')
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: '线上招聘会统计详情',
        meta: { i18n: 'work' },
        component: () => import(/* webpackChunkName: "views" */ '@/views/statistics/onlineDetail')
      },
      {
        path: 'offline/:id',
        name: '线下招聘会统计详情',
        meta: { i18n: 'work' },
        component: () => import(/* webpackChunkName: "views" */ '@/views/statistics/offlineDetail')
      }
    ]
  }
]
